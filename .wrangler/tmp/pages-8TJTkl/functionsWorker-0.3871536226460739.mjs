...
// ../.wrangler/tmp/bundle-pxsNvW/checked-fetch.js
...
var onRequestPost3 = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    response.headers.set(
      "Set-Cookie",
      `session=${sessionToken}; HttpOnly; SameSite=Lax; Max-Age=${7 * 24 * 60 * 60}; Path=/`
    );
    return response;
  } catch (error) {
...
var onRequestGet2 = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    const memberResult = await DB.prepare(
      "SELECT * FROM members WHERE id = ? AND is_active = 1"
    ).bind(sessionResult.member_id).first();
    if (!memberResult) {
...
// ../.wrangler/tmp/pages-8TJTkl/functionsRoutes-0.9320769475432371.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-pxsNvW/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-pxsNvW/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3871536226460739.mjs.map
