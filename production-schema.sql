-- Complete schema for Birchwood Country Club
-- This includes all tables needed for the application to function
...
-- Individual tee time bookings table (new approach)
CREATE TABLE IF NOT EXISTS tee_time_bookings (
    ...
    player_names TEXT, -- Names of players in this specific booking
    notes TEXT,
...
-- Legacy tee times table (kept for compatibility)
...
-- Tennis and pickleball court reservations table
...
-- Indexes for court reservations
