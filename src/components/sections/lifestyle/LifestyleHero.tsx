...
const LifestyleHero = () => {
  const scrollToNextSection = () => {
    const nextSection = document.getElementById('lifestyle-overview');
    if (nextSection) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img 
          src={poolImage} 
          alt="Birchwood Lifestyle - Pool and Recreation" 
      ...
      <div className="relative z-10 text-center text-white container-width section-padding">
        <div className="space-y-6 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold font-serif leading-tight">
            Active Lifestyle
            <span className="block text-primary-300">& Recreation</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-200 font-serif italic">
            World Class Recreational, Dining & Facilities in a Picturesque Setting
          </p>
          <p className="text-lg text-gray-300 leading-relaxed max-w-3xl mx-auto">
            Nestled in the rolling hills of northern Michigan, Birchwood offers an unparalleled lifestyle opportunity. 
            Not just a country club, Birchwood is a private, residential community offering luxury, resort style amenities for all ages.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <a href="#amenities" className="btn-primary">
              Explore Amenities
            </a>
