...
const ContactHero = () => {
  const scrollToNextSection = () => {
    const nextSection = document.getElementById('contact-info');
    if (nextSection) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img 
          src={frontImage} 
          alt="Birchwood Farms Country Club Entrance" 
      ...
      <div className="relative z-10 text-center text-white container-width section-padding">
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-300 leading-relaxed max-w-3xl mx-auto">
            Whether you're interested in membership, planning an event, or have questions 
            about our facilities, our team is ready to assist you. Reach out to us today 
            and discover the Birchwood Farms difference.
          </p>
